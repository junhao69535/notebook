...
def parse_qs(qs, keep_blank_values=0, strict_parsing=0):
    ...
    # 这个函数和parse_sql作用一样，返回的是一个多值字典,{name: [value1, value2]}
    # 如"name=test1&name=test2"被解析为{name: [test1, test2]}
...
def parse_qsl(qs, keep_blank_values=0, strict_parsing=0, max_num_fields=None):
    """Parse a query given as a string argument."""
    # 这个函数和parse_sq作用一样，返回的是一个列表，元素为(name, value)元组。
    # 如"name=test1&name=test2"被解析为[(name, value1), (name, value2)]
